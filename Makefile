CXX = g++
CXX_FLAGS = -O3 -g -Wall -fopenmp -m64 -I"${MKLROOT}/include" -std=c++17
...
main.o: main.cpp PB_matrix.h par_cholesky.h matrix_generator.h pardiso_test.h SparseMat.h Makefile
