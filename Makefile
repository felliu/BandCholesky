CXX = g++
CXX_FLAGS = -O3 -g -Wall -fopenmp -m64 -I"${MKLROOT}/include"#-I"${VTUNE_INCDIR}"

#VTUNE_LIB = /opt/intel/oneapi/vtune/latest/sdk/lib64/libittnotify.a
#VTUNE_INCDIR = /opt/intel/oneapi/vtune/latest/sdk/include

LD_FLAGS = -L${MKLROOT}/lib/intel64 -Wl,--no-as-needed -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -lm -ldl -liomp5 -lprofiler
